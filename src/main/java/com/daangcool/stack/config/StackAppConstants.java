 ...
 * JHipster constants.
 */
public interface StackAppConstants {
    ...
    /** Spring profile used when deploying to Local database
     Constant <code>SPRING_PROFILE_DATABASE="database"</code> */
    String SPRING_PROFILE_DATABASE = "database";
    /** Spring profile used when deploying to Oracle Cloud
     Constant <code>SPRING_PROFILE_ORACLE_CLOUD="oracle"</code> */
    String SPRING_PROFILE_ORACLE_CLOUD = "oracle";
}
